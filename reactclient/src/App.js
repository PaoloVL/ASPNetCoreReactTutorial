...
export default function App() {
                    ...
                    {(showingCreateNewPostForm === false && postCurrentlyBeingUpdated === null) && (
                        <div>
                            ...
                            <div className="mt-5">
                                ...
                                <button onClick={() => setShowingCreateNewPostForm(true)} className="btn btn-secondary btn-lg w-100 mt-4">Create new Posts</button>
                            </div>
                        </div>
                    )}
    ...
    function onPostDeleted(deletedPostPostId) {
        ...
        alert('Post successfully deleted. After clicking OK, look at the table below to see the post is removed.')
    }
}
